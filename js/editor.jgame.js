...
(function (jgeditor) {
    var JgPlayground = (function () {
        ...
        JgPlayground.prototype.getLocalizedDiagnosticMessages = function () {
            return null;
        };

        JgPlayground.prototype.resolveRelativePath = function (path, directory) {
            return path;
        };

        JgPlayground.prototype.getScriptByteOrderMark = function (fileName) {
            return ByteOrderMark.None;
        };

        JgPlayground.prototype.fileExists = function (path) {
            return false;
        };

        JgPlayground.prototype.directoryExists = function (path) {
            return false;
        };

        JgPlayground.prototype.getParentDirectory = function (path) {
            return null;
        };
...
(function (jgeditor) {
    var Editor = (function () {
        ...
        Editor.prototype.blurGame = function () {
            var con = document.getElementById(this.game_container_id);
            var w = con.contentWindow || con;
            try  {
                var container = w.document.getElementById("jgame");
...
(function (jgeditor) {
    var JavaScriptEditor = (function (_super) {
        ...
        JavaScriptEditor.prototype.onSorted = function (e) {
            var tabs = e.tabs;
            var new_scripts = [];
...
(function (jgeditor) {
    var TypeScriptEditor = (function (_super) {
        ...
        TypeScriptEditor.prototype.onSorted = function (e) {
        ...
        TypeScriptEditor.prototype.addError = function (diagnostic) {
            ...
            if (diagnostic.line !== undefined && diagnostic.line !== null) {
                ...
                row.click(function () {
                    if (_this.playground.current() != diagnostic.file)
                        _this.changeTab(diagnostic.file);
                    _this.editor.clearSelection();
                    _this.editor.moveCursorTo(diagnostic.line - 1, diagnostic.rowpos);
                    _this.editor.focus();
                });
            } else {
        ...
        TypeScriptEditor.prototype.getRelativeName = function (name) {
            if (name.substr(0, 1) == "/")
