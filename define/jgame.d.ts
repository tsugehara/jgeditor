...
declare module jg {
    ...
    */
    interface IEntityOptions {
        ...
        /**
        * 線の末端形状。
        * butt, round, squareのいずれかを指定。デフォルトはbutt
        */
        lineCap?: string;
        /**
        * 線の結合形状。
        * bevel, round, miterのいずれかを指定。デフォルトはmiter
        */
        lineJoin?: string;
        /** 線の太さ */
        lineWidth?: number;
        ...
        /**
        * 文字の方向。
        * start, end, left, right, centerのいずれかを指定。デフォルトはstart
        */
        textAlign?: string;
        /**
        * 文字基準線。
        *  top, hanging, middle, alphabetic, ideographic, bottomのいずれかを指定。デフォルトはalphabetic
        */
        textBaseline?: string;
        /**
        * 結合方式。以下いずれか、または各種ベンダー拡張方式を指定。
        * source-atop
        * source-in
        * source-out
        * source-over (default)
...
declare module jg {
    ...
    */
    class AutoTileChipSet extends ChipSet {
        ...
        */
        public map(tile: Tile, x: number, y: number, out_value?: number): number;
        /**
        * このChipSetで管理しているチップ数を取得する。
    ...
    */
    class Tile extends jg.E {
        ...
        */
        public clear(width?: number, height?: number, value?: number): void;
        /**
        * マップデータを生成する
